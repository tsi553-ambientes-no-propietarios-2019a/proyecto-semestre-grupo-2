 ...
 */
final class Version20190801162011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE compra (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, paquete_id INT DEFAULT NULL, habitacion_id INT DEFAULT NULL, schedule_id INT DEFAULT NULL, fecha_com DATETIME NOT NULL, no_asientos INT DEFAULT NULL, total_asientos NUMERIC(10, 2) DEFAULT NULL, no_habita INT DEFAULT NULL, total_paquetes NUMERIC(10, 2) DEFAULT NULL, no_paquetes INT DEFAULT NULL, total_habita NUMERIC(10, 2) DEFAULT NULL, total_compra NUMERIC(10, 2) NOT NULL, INDEX IDX_9EC131FFA76ED395 (user_id), INDEX IDX_9EC131FF41E2D57E (paquete_id), INDEX IDX_9EC131FFB009290D (habitacion_id), INDEX IDX_9EC131FFA40BC2D5 (schedule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, bus_id INT NOT NULL, origin_city_id INT DEFAULT NULL, destiny_city_id INT DEFAULT NULL, day VARCHAR(50) NOT NULL, hour TIME NOT NULL, price NUMERIC(5, 2) NOT NULL, INDEX IDX_5A3811FB2546731D (bus_id), INDEX IDX_5A3811FB3EDB77C2 (origin_city_id), INDEX IDX_5A3811FB15ECDDA9 (destiny_city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
