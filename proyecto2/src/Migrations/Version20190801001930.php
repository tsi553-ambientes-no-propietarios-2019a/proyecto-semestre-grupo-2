 ...
 */
final class Version20190801001930 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hotel CHANGE city_id city_id INT NOT NULL');
        $this->addSql('ALTER TABLE paquetes ADD extras VARCHAR(255) NOT NULL, ADD price NUMERIC(10, 2) NOT NULL, ADD duration VARCHAR(255) NOT NULL, ADD date DATE NOT NULL, DROP no_days');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compra CHANGE paquete_id paquete_id INT DEFAULT NULL, CHANGE habitacion_id habitacion_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE habitaciones CHANGE hotel_id hotel_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE hotel CHANGE city_id city_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE paquetes ADD no_days INT NOT NULL, DROP extras, DROP price, DROP duration, DROP date');
